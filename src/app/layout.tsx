...
export const metadata: Metadata = {
  ...
  // 147 χαρακτήρες: κάτω από το όριο εμφάνισης της Google (~155). Η
  // προηγούμενη εκδοχή ήταν 180 και κοβόταν στη μέση του CTA.
  description:
    "Επιστημονικά τεκμηριωμένη φυσικοθεραπεία από τον Μιχάλη Σιούλη στη Μεταμόρφωση Αττικής. Συμβεβλημένος με ΕΟΠΥΥ. Κλείστε ραντεβού online σε 1 λεπτό.",
  alternates: {
    canonical: "/",
  },
