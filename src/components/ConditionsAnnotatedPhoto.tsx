  ...
  return (
    <div className="w-full flex flex-col items-center lg:items-end gap-4">
      ...
      <div className="relative w-full max-w-[360px] sm:max-w-[400px] lg:max-w-[440px]">
        ...
        {/* `athletenobg1.webp` — η σωστή εκδοχή της φωτογραφίας.
            -------------------------------------------------------------------
            Το `athletenobg.webp` που χρησιμοποιούνταν πριν είναι το ΙΔΙΟ κάδρο
            αλλά ΧΩΡΙΣ τις εννέα μπλε γραμμές-δείκτες που είναι τυπωμένες μέσα
            στην εικόνα. Οι συντεταγμένες των hotspot παρακάτω ήταν εξαρχής
            φτιαγμένες για αυτή εδώ: επτά από τις εννέα πέφτουν στην άκρη της
            αντίστοιχης γραμμής με απόκλιση κάτω από 0,2%.

            Οι διαστάσεις είναι οι πραγματικές του αρχείου (1068×1472). Ο λόγος
            πλευρών είναι ουσιαστικά ίδιος με πριν (0,7255 έναντι 0,7258),
            οπότε η διάταξη δεν μετακινείται. */}
        <Image
          src="/images/athletenobg1.webp"
