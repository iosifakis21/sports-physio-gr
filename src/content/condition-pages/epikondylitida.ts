 ...
 *
 * ΑΥΤΟΥΣΙΟ κείμενο από τη σελίδα «Επικονδυλίτιδα» του παλιού sports-physio.gr
 * (path-seis/.../agk-nas/epikondyl-tida.html): ίδιες λέξεις, ίδιες
 * υπο-επικεφαλίδες, ίδια σειρά. Δεν έχει γίνει καμία διόρθωση — μένουν ως
 * έχουν τα «επικονδυλίτιτδα», «προσβάλεται», «πού τεντώνουν», «Πρωϊνή», και
 * το εισαγωγικό της στατιστικής που η πηγή δεν κλείνει ποτέ.
 *
 * ΠΑΡΕΜΒΑΣΕΙΣ ΚΩΔΙΚΟΠΟΙΗΣΗΣ (όχι διατύπωσης): η πηγή έγραφε «Tennis Εlbow»
 * με ελληνικό «Ε» και «Κinesiotaping» με ελληνικό «Κ» — μπήκαν τα λατινικά,
 * αλλιώς οι λέξεις δεν βρίσκονται στην αναζήτηση.
 */
export const epikondylitidaPage: ConditionPageContent = {
  ...
  whatIs: [
    ...
    "Η ανατομική βλάβη είναι μικροσκοπική αποκόλληση ινών των εκτεινόντων τενόντων (πού τεντώνουν τον καρπό και τα δάκτυλα), στον έξω επικόνδυλο του βραχιονίου οστού.",
