 ...
 *
 * ΑΥΤΟΥΣΙΟ κείμενο από τη σελίδα «Πελματιαία απονευρωσίτιδα» του παλιού
 * sports-physio.gr (path-seis/.../podoknimik/pelmatia-a-aponeyros-tida.html):
 * ίδιες λέξεις, ίδιες υπο-επικεφαλίδες, ίδια σειρά.
 */
  ...
  whatIs: [
    ...
    },
    {
      ...
      items: [
        ...
        "Η πολύ υψηλή ή χαμηλή καμάρα, ο υπέρ – πρηνισμός του ποδιού και η παχυσαρκία,",
