 ...
 *
 * ΑΥΤΟΥΣΙΟ κείμενο από τη σελίδα «Σύνδρομο πρόσκρουσης η υπακρωμιακής
 * προστριβής» του παλιού sports-physio.gr: ίδιες λέξεις, ίδιες
 * υπο-επικεφαλίδες, ίδια σειρά (Αιτίες → Κλινική εικόνα → Προσοχή! →
 * Διάγνωση → Θεραπεία). Δεν έχει γίνει καμία διόρθωση — ούτε στο «υπέρχηση»,
 * «δεομένου» και «τις αυχενικής μοίρας» της πηγής.
 */
export const syndromoProskroysisYpakromiakisProstrivisPage: ConditionPageContent = {
  ...
  symptoms: [
    ...
    {
      kind: "paragraph",
      text: "Είναι πολύ σημαντικό για την σωστή διάγνωση εδώ να αποκλειστούν άλλα αίτια που μπορεί να δίνουν τα ίδια συμπτώματα, όπως παθολογικές καταστάσεις τις αυχενικής μοίρας.",
    },
  ],
