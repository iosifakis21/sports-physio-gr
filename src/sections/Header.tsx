...
export const Header: React.FC = () => {
    ...
    return (
        <>
            <header
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 w-full h-[80px] flex items-center justify-between px-4 md:px-8 border-b ${isScrolled
            ...
            <div
                ...
                ref={menuRef}
                className={`fixed top-0 right-0 bottom-0 z-50 w-full max-w-[300px] bg-surface shadow-2xl p-6 flex flex-col justify-between transform transition-transform duration-300 ease-in-out lg:hidden ${isMenuOpen ? "translate-x-0" : "translate-x-full"
                    }`}
